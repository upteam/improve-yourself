...
import logging
logger = logging.getLogger('migration.stock')
...
def migrate(cr, v):
    ...
    logger.info('Alter stock structure')
    # TODO Check this delete
    #reports cannot have both report_xsl and report_rml
    #update ir_act_report_xml set report_xsl = null where ...
